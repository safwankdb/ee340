...
# Title: Top Block
# Generated: Thu Oct 10 16:17:10 2019
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._slider1_range = Range(-100e3, 100e3, 100, 0, 200)
        self._slider1_win = RangeWidget(self._slider1_range, self.set_slider1, "slider1", "counter_slider", float)
        self.top_layout.addWidget(self._slider1_win)
        self.rtlsdr_source_0 = osmosdr.source( args="numchan=" + str(1) + " " + '' )
        self.rtlsdr_source_0.set_sample_rate(samp_rate)
        self.rtlsdr_source_0.set_center_freq(1.2e9+slider1, 0)
        ...
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate/50,True)
    ...
    def set_slider1(self, slider1):
        self.slider1 = slider1
        self.rtlsdr_source_0.set_center_freq(1.2e9+self.slider1, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_throttle_0.set_sample_rate(self.samp_rate/50)
